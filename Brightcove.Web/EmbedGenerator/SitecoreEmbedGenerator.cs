...
namespace Brightcove.Web.EmbedGenerator
{
    public class SitecoreEmbedGenerator : BrightcoveEmbedGenerator
    {
        public SitecoreEmbedGenerator() : base()
        {
            ...
            jsTemplate = "<div class='brightcove-media-container brightcove-media-container-js' style='width: {4}px;'><video data-account='{0}' data-player='{1}' data-embed='default' controls='true' data-video-id='{2}' data-playlist-id='{3}' data-application-id='' width='{4}' height='{5}' class='video-js'></video>{6}</div>";
            jsResponsiveTemplate = "<div class='brightcove-media-container brightcove-media-container-js' style='max-width: {4}px;'><style>div.video-js:not(.vjs-audio-only-mode) {{padding-top: {5}%; width: 100%}} video.video-js {{width: 100%}}</style><video data-account='{0}' data-player='{1}' data-embed='default' controls='true' data-video-id='{2}' data-playlist-id='{3}' data-application-id='' class='video-js'></video>{6}</div>";
